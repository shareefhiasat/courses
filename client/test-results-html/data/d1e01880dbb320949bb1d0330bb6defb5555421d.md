...
- Name: dark-mode-ui.spec.js >> TC-DM-UI-030: Penalties renders correctly [Light Mode]
- Location: tests/e2e/specs/dark-mode-ui.spec.js:183:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/penalties
Call log:
  - navigating to "https://localhost:5174/penalties", waiting until "load"
