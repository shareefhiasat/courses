...
- Name: arabic-rtl-ui.spec.js >> Arabic/RTL UI — Arabic lang Attribute on Every Major Page >> TC-ARTRL-UI-51: Behavior has lang="ar" attribute
...
Call log:
  - navigating to "https://localhost:5174/behavior", waiting until "load"
