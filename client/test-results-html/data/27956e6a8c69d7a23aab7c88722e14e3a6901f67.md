...
- Name: arabic-rtl-ui.spec.js >> Arabic/RTL UI — No English Leakage on Major Pages >> TC-ARTRL-UI-66: Programs — no English button labels in Arabic mode
- Location: tests/e2e/specs/arabic-rtl-ui.spec.js:159:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/programs
Call log:
  - navigating to "https://localhost:5174/programs", waiting until "load"
