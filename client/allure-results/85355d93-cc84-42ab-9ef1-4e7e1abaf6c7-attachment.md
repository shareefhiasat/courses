...
- Name: users-ui.spec.js >> Users UI — Create Flow (Deep) >> TC-USR-UI-008: Form validation — empty submit shows errors
- Location: tests/e2e/specs/users-ui.spec.js:129:3
