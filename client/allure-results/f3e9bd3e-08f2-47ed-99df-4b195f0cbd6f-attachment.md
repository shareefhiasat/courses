...
- Name: workflow-pages-ui.spec.js >> Workflow Pages UI — Unauthenticated >> TC-WFP-UI-028: Analytics redirect to login
- Location: tests/e2e/specs/workflow-pages-ui.spec.js:277:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/workflow/analytics
Call log:
  - navigating to "https://localhost:5174/workflow/analytics", waiting until "load"
