...
- Name: penalties-ui.spec.js >> Penalties UI — Delete Flow (Read-only checks) >> TC-PEN-UI-021: Delete — confirm dialog appears
- Location: tests/e2e/specs/penalties-ui.spec.js:614:3
