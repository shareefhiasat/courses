...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — User Stories >> TC-SCHCAL-UI-061: User story — admin sets instructor availability slot
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:716:3
