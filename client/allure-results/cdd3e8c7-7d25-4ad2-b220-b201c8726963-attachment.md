...
- Name: analytics-ui.spec.js >> Analytics UI — Widget Builder (Deep) >> TC-ANL-UI-055: Builder close (X) button works
- Location: tests/e2e/specs/analytics-ui.spec.js:633:3
