...
- Name: dashboard-admin-ui.spec.js >> Dashboard Admin UI — Page Load & Structure >> TC-DASH-ADMIN-UI-003: Tab header shows current tab name
- Location: tests/e2e/specs/dashboard-admin-ui.spec.js:66:3
