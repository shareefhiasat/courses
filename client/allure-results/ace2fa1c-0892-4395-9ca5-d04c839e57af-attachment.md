...
- Name: analytics-ui.spec.js >> Analytics UI — Advanced Analytics Header (Deep) >> TC-ANL-UI-014: Auto-refresh progress bar appears when enabled
- Location: tests/e2e/specs/analytics-ui.spec.js:192:3
