...
- Name: dark-mode-ui.spec.js >> Dark Mode — Theme Toggle >> TC-DM-UI-006: Light mode persists in localStorage
- Location: tests/e2e/specs/dark-mode-ui.spec.js:118:3
...
```ts
  22  |  * - Charts/widgets render in dark mode
  23  |  * - RTL + dark mode combined
  24  |  */
  25  | import { test, expect } from '@playwright/test';
  26  | import { testConfig } from '../config/test.config.js';
  27  | import { gotoWithAuth, waitForContent, dismissOverlays } from '../utils/ui-helpers.js';
  28  | import {
  29  |   applyTheme,
  30  |   applyDarkMode,
  31  |   applyLightMode,
