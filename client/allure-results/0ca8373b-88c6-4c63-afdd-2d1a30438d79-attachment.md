...
- Name: home-ui.spec.js >> Home Page UI — Resources Mode (Deep) >> TC-HOME-UI-026: Resource search filters results
- Location: tests/e2e/specs/home-ui.spec.js:247:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/?mode=resources
Call log:
  - navigating to "https://localhost:5174/?mode=resources", waiting until "load"
