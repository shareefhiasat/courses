...
- Name: auth.spec.js >> Authentication — Unauthorized Page >> TC-AUTH-037: Unauthorized page shows access denied heading
- Location: tests/e2e/specs/auth.spec.js:478:3
