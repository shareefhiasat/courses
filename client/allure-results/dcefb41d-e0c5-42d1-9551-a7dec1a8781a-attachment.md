...
- Name: missing-routes-ui.spec.js >> Unauthorized & QR Code — Deep >> TC-MR-UI-013: Unauthorized page loads with 403 message
- Location: tests/e2e/specs/missing-routes-ui.spec.js:135:3
...
Call log:
  - navigating to "https://localhost:5174/unauthorized", waiting until "load"
