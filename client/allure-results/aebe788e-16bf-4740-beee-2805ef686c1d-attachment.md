...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Classes Tab >> TC-SCHCAL-UI-010: Classes availability tab loads
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:120:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/scheduling-calendar?tab=classes
Call log:
