...
- Name: analytics-ui.spec.js >> Analytics UI — Student Dashboard Component Reuse (Deep) >> TC-ANL-UI-107: Switch to Performance tab renders DashboardEngine
- Location: tests/e2e/specs/analytics-ui.spec.js:1284:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/student-dashboard
Call log:
