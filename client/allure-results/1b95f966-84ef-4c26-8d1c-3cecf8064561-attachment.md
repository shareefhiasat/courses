...
- Name: activities-ui.spec.js >> Activities UI — Delete Flow (Read-only checks) >> TC-ACT-UI-021: Delete button visible for existing activity
- Location: tests/e2e/specs/activities-ui.spec.js:432:3
