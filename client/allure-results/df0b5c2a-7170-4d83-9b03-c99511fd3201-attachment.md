...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-101: Instructor cannot see Clear Today button on QR scanner
- Location: tests/e2e/specs/attendance-ui.spec.js:1562:3
