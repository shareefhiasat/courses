...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-100: Admin cannot see Clear Today button on QR scanner
- Location: tests/e2e/specs/attendance-ui.spec.js:1554:3
