...
- Name: announcements-ui.spec.js >> Announcements UI — Role-Based Access (Deep) >> TC-ANN-UI-024: Student cannot see create button
- Location: tests/e2e/specs/announcements-ui.spec.js:406:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/dashboard?tab=announcements
Call log:
  - navigating to "https://localhost:5174/dashboard?tab=announcements", waiting until "load"
