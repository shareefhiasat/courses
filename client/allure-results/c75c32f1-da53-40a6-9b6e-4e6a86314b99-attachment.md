...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Withdraw & Transfer (Deep) >> TC-MENR-UI-012: Unenroll — confirm dialog appears, then cancel
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:135:3
