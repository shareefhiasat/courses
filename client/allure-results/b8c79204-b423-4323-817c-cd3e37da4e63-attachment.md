...
- Name: classes-ui.spec.js >> Classes UI — Create Flow (Deep) >> TC-CLS-UI-008: Form validation — empty submit shows errors
- Location: tests/e2e/specs/classes-ui.spec.js:122:3
