...
- Name: attendance-ui.spec.js >> Attendance UI — Export >> TC-ATT-UI-071: Export button disabled when no class selected
- Location: tests/e2e/specs/attendance-ui.spec.js:1085:3
