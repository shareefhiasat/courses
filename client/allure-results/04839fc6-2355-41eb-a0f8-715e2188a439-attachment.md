...
- Name: analytics-ui.spec.js >> Analytics UI — Global Filters (Deep) >> TC-ANL-UI-034: Selecting class filter updates widget data
- Location: tests/e2e/specs/analytics-ui.spec.js:373:3
