...
- Name: activities-ui.spec.js >> Activities UI — Page Load & Structure >> TC-ACT-UI-004: Row count is non-zero or empty state shown
- Location: tests/e2e/specs/activities-ui.spec.js:68:3
