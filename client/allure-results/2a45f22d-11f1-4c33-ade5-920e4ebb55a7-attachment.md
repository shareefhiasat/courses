...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Role-Based Access (Deep) >> TC-MENR-UI-021: Instructor can access manage enrollments
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:247:3
