...
- Name: arabic-rtl-ui.spec.js >> Arabic/RTL UI — Arabic lang Attribute on Every Major Page >> TC-ARTRL-UI-49: Penalty has lang="ar" attribute
- Location: tests/e2e/specs/arabic-rtl-ui.spec.js:132:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/penalty
Call log:
