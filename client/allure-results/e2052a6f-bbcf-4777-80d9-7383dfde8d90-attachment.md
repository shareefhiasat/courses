...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Page Load & Calendar >> TC-SCHCAL-UI-008: Availability tab visible on page load
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:98:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/scheduling-calendar
Call log:
