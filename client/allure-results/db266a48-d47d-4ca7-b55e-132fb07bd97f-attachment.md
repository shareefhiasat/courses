...
- Name: auth.spec.js >> Authentication — Protected Route Enforcement >> TC-AUTH-034: Unauthenticated /analytics redirects to login
- Location: tests/e2e/specs/auth.spec.js:452:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/analytics
Call log:
