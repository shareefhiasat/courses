...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Enroll Flow (Deep) >> TC-MENR-UI-009: Enroll form has class selector
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:99:3
