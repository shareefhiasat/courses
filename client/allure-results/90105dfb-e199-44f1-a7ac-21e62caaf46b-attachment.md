...
- Name: enrollments-ui.spec.js >> Enrollments UI — Delete Flow (Deep) >> TC-ENR-UI-023: Delete — cancelled, enrollment remains in list
- Location: tests/e2e/specs/enrollments-ui.spec.js:393:3
