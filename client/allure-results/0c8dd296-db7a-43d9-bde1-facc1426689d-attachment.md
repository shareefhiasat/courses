...
- Name: auth.spec.js >> Authentication — Protected Route Enforcement >> TC-AUTH-032: Unauthenticated /manage-enrollments redirects to login
- Location: tests/e2e/specs/auth.spec.js:438:3
