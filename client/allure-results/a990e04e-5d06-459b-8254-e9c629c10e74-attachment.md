...
- Name: analytics-ui.spec.js >> Analytics UI — Summary Dashboard (Deep) >> TC-ANL-UI-008: Summary dashboard — select filter changes content
- Location: tests/e2e/specs/analytics-ui.spec.js:127:3
