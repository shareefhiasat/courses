...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Page Load & Structure (Deep) >> TC-MENR-UI-002: Enrollments table or list renders
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:39:3
