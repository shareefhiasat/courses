...
- Name: activities-ui.spec.js >> Activities UI — Delete Flow (Read-only checks) >> TC-ACT-UI-022: Delete — confirm dialog appears
- Location: tests/e2e/specs/activities-ui.spec.js:439:3
