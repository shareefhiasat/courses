...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-099: Instructor cannot see Bulk Scan button on QR scanner
- Location: tests/e2e/specs/attendance-ui.spec.js:1546:3
