...
- Name: missing-routes-ui.spec.js >> Dashboard Lookup Tabs UI — Deep >> TC-MR-UI-39: resource-types tab loads with content
...
Call log:
  - navigating to "https://localhost:5174/dashboard#resource-types", waiting until "load"
