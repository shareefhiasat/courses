...
- Name: analytics-ui.spec.js >> Analytics UI — Widget Actions (Deep) >> TC-ANL-UI-066: Widget title visible in header
- Location: tests/e2e/specs/analytics-ui.spec.js:802:3
