...
- Name: missing-routes-ui.spec.js >> Activity Detail & Quiz Pages — Deep >> TC-MR-UI-015: Activity detail page loads
- Location: tests/e2e/specs/missing-routes-ui.spec.js:160:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/activity/1
Call log:
  - navigating to "https://localhost:5174/activity/1", waiting until "load"
