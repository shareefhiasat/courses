...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-096: HR cannot see Start Session (canCreate = false)
- Location: tests/e2e/specs/attendance-ui.spec.js:1500:3
