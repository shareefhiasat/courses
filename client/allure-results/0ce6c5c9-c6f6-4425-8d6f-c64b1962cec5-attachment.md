...
- Name: enrollments-ui.spec.js >> Enrollments UI — Create Flow (Deep) >> TC-ENR-UI-006: Enroll form opens with expected fields
- Location: tests/e2e/specs/enrollments-ui.spec.js:87:3
