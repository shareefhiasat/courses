...
- Name: analytics-ui.spec.js >> Analytics UI — User Stories >> TC-ANL-UI-098: User story — admin resets dashboard to defaults
- Location: tests/e2e/specs/analytics-ui.spec.js:1194:3
