...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-091: Admin cannot see delete button in expanded history
- Location: tests/e2e/specs/attendance-ui.spec.js:1431:3
