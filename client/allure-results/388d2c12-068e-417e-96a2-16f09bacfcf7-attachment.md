...
- Name: activities-ui.spec.js >> Activities UI — Create Flow (Deep) >> TC-ACT-UI-009: Form validation — empty submit shows errors
- Location: tests/e2e/specs/activities-ui.spec.js:119:3
