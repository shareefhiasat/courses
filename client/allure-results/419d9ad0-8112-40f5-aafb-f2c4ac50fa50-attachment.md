...
- Name: enrollments-ui.spec.js >> Enrollments UI — User Story & Bulk >> TC-ENR-UI-027: User story — admin enrolls student and verifies
- Location: tests/e2e/specs/enrollments-ui.spec.js:445:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/enrollments
Call log:
