...
- Name: enrollments-ui.spec.js >> Enrollments UI — Delete Flow (Deep) >> TC-ENR-UI-021: Delete button visible for existing enrollment
- Location: tests/e2e/specs/enrollments-ui.spec.js:358:3
