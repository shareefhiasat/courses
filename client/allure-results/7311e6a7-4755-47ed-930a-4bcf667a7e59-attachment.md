...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-095: HR sees attendance page (canView = true)
- Location: tests/e2e/specs/attendance-ui.spec.js:1493:3
