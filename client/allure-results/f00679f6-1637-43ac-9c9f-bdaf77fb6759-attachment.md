...
- Name: global-ui.spec.js >> Global UI — Sidebar Navigation (Deep) >> TC-GLB-UI-007: Academic Records section expands with sub-items
- Location: tests/e2e/specs/global-ui.spec.js:79:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/
Call log:
