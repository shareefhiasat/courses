...
- Name: activities-ui.spec.js >> Activities UI — Create Flow (Deep) >> TC-ACT-UI-006: Create form opens with expected fields
- Location: tests/e2e/specs/activities-ui.spec.js:92:3
