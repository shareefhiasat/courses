...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-102: Super admin can see Bulk Scan and Clear Today on QR scanner
- Location: tests/e2e/specs/attendance-ui.spec.js:1570:3
