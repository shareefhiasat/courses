...
- Name: enrollments-ui.spec.js >> Enrollments UI — Page Load & Structure >> TC-ENR-UI-004: Row count is non-zero or empty state shown
- Location: tests/e2e/specs/enrollments-ui.spec.js:63:3
