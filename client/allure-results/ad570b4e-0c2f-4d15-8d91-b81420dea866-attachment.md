...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Tab Switch Verification >> TC-SCHCAL-UI-050: Switch from calendar to classes tab changes content
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:583:3
