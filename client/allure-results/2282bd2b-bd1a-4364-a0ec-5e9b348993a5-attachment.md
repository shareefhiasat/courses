...
- Name: analytics-ui.spec.js >> Analytics UI — Summary Dashboard (Deep) >> TC-ANL-UI-009: Instructor can access summary dashboard
- Location: tests/e2e/specs/analytics-ui.spec.js:139:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/summary-dashboard
Call log:
  - navigating to "https://localhost:5174/summary-dashboard", waiting until "load"
