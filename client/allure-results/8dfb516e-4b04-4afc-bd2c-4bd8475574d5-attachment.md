...
- Name: announcements-ui.spec.js >> Announcements UI — Read & Search (Deep) >> TC-ANN-UI-014: Sort by column header changes row order
- Location: tests/e2e/specs/announcements-ui.spec.js:218:3
