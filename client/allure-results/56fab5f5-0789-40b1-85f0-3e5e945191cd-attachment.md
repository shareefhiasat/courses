...
- Name: announcements-ui.spec.js >> Announcements UI — Create Flow (Deep) >> TC-ANN-UI-006: Create form opens with all expected fields
- Location: tests/e2e/specs/announcements-ui.spec.js:81:3
