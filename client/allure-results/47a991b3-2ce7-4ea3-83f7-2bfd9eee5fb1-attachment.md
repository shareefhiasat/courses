...
- Name: attendance-ui.spec.js >> Daily Scan — Comprehensive Button Tests >> TC-ATT-UI-136: Action buttons disabled when no student selected
- Location: tests/e2e/specs/attendance-ui.spec.js:2051:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/qr-scanner
Call log:
  - navigating to "https://localhost:5174/qr-scanner", waiting until "load"
