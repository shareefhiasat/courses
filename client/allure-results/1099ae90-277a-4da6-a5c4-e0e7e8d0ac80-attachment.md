...
- Name: missing-routes-ui.spec.js >> Dashboard Lookup Tabs UI — Deep >> TC-MR-UI-42: subject-types tab loads with content
...
Call log:
  - navigating to "https://localhost:5174/dashboard#subject-types", waiting until "load"
