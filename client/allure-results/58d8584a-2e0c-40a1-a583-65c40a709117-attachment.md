...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Summary Dashboard >> TC-SCHCAL-UI-048: Summary dashboard — instructor utilization stat
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:567:3
