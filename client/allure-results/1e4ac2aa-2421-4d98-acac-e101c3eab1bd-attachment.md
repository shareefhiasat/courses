...
- Name: dark-mode-ui.spec.js >> TC-DM-UI-018: Scheduling Availability renders correctly [Light Mode]
...
Call log:
  - navigating to "https://localhost:5174/scheduling-calendar?tab=availability", waiting until "load"
