...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Workflow Deep Tests >> TC-MENR-UI-038: Transfer button visible per row
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:455:3
