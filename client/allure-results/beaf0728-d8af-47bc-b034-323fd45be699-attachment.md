...
- Name: penalties-ui.spec.js >> Penalties UI — Edit Flow (Read-only checks) >> TC-PEN-UI-018: Edit — form pre-fills with penalty data
- Location: tests/e2e/specs/penalties-ui.spec.js:568:3
