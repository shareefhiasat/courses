...
- Name: rbac-api.spec.js >> RBAC - API Access Control >> TC-RBAC-004: student GET /users/me returns 200
- Location: tests/e2e/specs/rbac-api.spec.js:40:3
...
> 42  |     expect(res.status).toBe(200);
  ...
  137 |     expect([403, 401, 500, 400]).toContain(res.status);
  138 |   });
  139 | 
  140 |   // ═══════════════════════════════════════════════════════════════════════════
  141 |   // SECTION 5: Unauthenticated access denial (TC-RBAC-019 — TC-RBAC-020)
  142 |   // ═══════════════════════════════════════════════════════════════════════════
```