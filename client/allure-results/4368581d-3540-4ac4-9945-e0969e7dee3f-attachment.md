...
- Name: dashboard-admin-ui.spec.js >> Dashboard Admin UI — Page Load & Structure >> TC-DASH-ADMIN-UI-004: Tab content area renders
- Location: tests/e2e/specs/dashboard-admin-ui.spec.js:71:3
