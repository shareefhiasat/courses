...
- Name: announcements-ui.spec.js >> Announcements UI — Create Flow (Deep) >> TC-ANN-UI-008: Form validation — empty submit shows errors
- Location: tests/e2e/specs/announcements-ui.spec.js:134:3
