...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Instructor Availability >> TC-SCHCAL-UI-031: Recurring availability — weekly pattern with day selection
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:364:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/scheduling-calendar?tab=availability&scope=instructor
Call log:
  - navigating to "https://localhost:5174/scheduling-calendar?tab=availability&scope=instructor", waiting until "load"
