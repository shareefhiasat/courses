...
- Name: dashboard-admin-ui.spec.js >> Dashboard Admin UI — Page Load & Structure >> TC-DASH-ADMIN-UI-002: Ribbon tab navigation visible
- Location: tests/e2e/specs/dashboard-admin-ui.spec.js:60:3
