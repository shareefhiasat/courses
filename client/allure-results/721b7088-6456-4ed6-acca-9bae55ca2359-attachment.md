...
- Name: missing-routes-ui.spec.js >> Unauthorized & QR Code — Deep >> TC-MR-UI-014: QR code page loads for student ID
- Location: tests/e2e/specs/missing-routes-ui.spec.js:149:3
...
Call log:
  - navigating to "https://localhost:5174/qrcode/test-student-id", waiting until "load"
