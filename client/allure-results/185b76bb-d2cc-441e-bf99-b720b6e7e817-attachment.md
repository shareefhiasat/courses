...
- Name: activities-ui.spec.js >> Activities UI — Create Flow (Deep) >> TC-ACT-UI-010: Cancel button — form data not saved without submit
- Location: tests/e2e/specs/activities-ui.spec.js:129:3
