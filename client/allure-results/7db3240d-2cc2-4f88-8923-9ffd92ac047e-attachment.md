...
- Name: resources-participations-behaviors-ui.spec.js >> Behaviors UI — Page Load & Structure >> TC-BEH-UI-002: Behaviors list or empty state renders
- Location: tests/e2e/specs/resources-participations-behaviors-ui.spec.js:320:3
