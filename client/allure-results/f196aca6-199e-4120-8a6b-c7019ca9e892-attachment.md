...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Page Load & Structure (Deep) >> TC-MENR-UI-005: Student search visible
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:57:3
