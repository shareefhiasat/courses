...
- Name: enrollments-ui.spec.js >> Enrollments UI — Create Flow (Deep) >> TC-ENR-UI-008: Form validation — empty submit shows errors
- Location: tests/e2e/specs/enrollments-ui.spec.js:132:3
