...
- Name: missing-routes-ui.spec.js >> Dashboard Lookup Tabs UI — Deep >> TC-MR-UI-43: assessment-types tab loads with content
...
Call log:
  - navigating to "https://localhost:5174/dashboard#assessment-types", waiting until "load"
