...
- Name: analytics-ui.spec.js >> Analytics UI — Student Dashboard Role-Based >> TC-ANL-UI-122: Student does not see Class tab
- Location: tests/e2e/specs/analytics-ui.spec.js:1465:3
...
Call log:
  - waiting for locator('button[type="submit"], input[type="submit"], button[name="login"]').first()
