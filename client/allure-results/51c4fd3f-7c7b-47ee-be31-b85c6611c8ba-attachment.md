...
- Name: analytics-ui.spec.js >> Analytics UI — Student Dashboard Component Reuse (Deep) >> TC-ANL-UI-112: Class tab — reset to defaults button visible
- Location: tests/e2e/specs/analytics-ui.spec.js:1339:3
