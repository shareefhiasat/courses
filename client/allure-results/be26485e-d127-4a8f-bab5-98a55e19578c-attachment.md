...
- Name: analytics-ui.spec.js >> Analytics UI — Advanced Analytics Header (Deep) >> TC-ANL-UI-020: Manage Widgets button visible (super admin only)
- Location: tests/e2e/specs/analytics-ui.spec.js:245:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/advanced-analytics
Call log:
