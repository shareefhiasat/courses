...
- Name: analytics-ui.spec.js >> Analytics UI — Advanced Analytics Header (Deep) >> TC-ANL-UI-025: Loading skeleton shows during data fetch
- Location: tests/e2e/specs/analytics-ui.spec.js:276:3
