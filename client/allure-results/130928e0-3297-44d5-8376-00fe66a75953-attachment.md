...
- Name: scheduling-ui.spec.js >> Scheduling UI — Break & Holiday Management >> TC-SCH-UI-066: Break form has event type selector (break/holiday)
- Location: tests/e2e/specs/scheduling-ui.spec.js:895:3
