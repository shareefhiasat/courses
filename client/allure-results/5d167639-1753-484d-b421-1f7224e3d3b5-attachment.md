...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Role-Based Access (Deep) >> TC-MENR-UI-024: Student cannot see bulk operations
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:276:3
