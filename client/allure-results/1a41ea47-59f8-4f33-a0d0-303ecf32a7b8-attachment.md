...
- Name: dashboard-admin-ui.spec.js >> Dashboard Admin UI — Page Load & Structure >> TC-DASH-ADMIN-UI-005: Dashboard has multiple ribbon categories
- Location: tests/e2e/specs/dashboard-admin-ui.spec.js:77:3
