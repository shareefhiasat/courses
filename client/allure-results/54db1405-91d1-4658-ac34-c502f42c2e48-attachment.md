...
- Name: activities-api.spec.js >> Activities API >> TC-ACT-RBAC-STUDENT: Student cannot create activity
- Location: tests/e2e/specs/activities-api.spec.js:78:3
