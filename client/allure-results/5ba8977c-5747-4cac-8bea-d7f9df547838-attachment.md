...
- Name: announcements-ui.spec.js >> Announcements UI — Create Flow (Deep) >> TC-ANN-UI-010: Cancel button — form data not saved without submit
- Location: tests/e2e/specs/announcements-ui.spec.js:155:3
