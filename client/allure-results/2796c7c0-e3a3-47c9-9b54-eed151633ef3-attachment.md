...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Withdraw & Transfer (Deep) >> TC-MENR-UI-011: Unenroll button on row
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:129:3
