...
- Name: enrollments-ui.spec.js >> Enrollments UI — Create Flow (Deep) >> TC-ENR-UI-005: Enroll button visible for admin
- Location: tests/e2e/specs/enrollments-ui.spec.js:81:3
