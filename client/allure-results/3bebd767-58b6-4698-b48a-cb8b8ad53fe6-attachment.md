...
- Name: users-ui.spec.js >> Users UI — Role-Based Access (Deep) >> TC-USR-UI-025: Instructor cannot access users page
- Location: tests/e2e/specs/users-ui.spec.js:416:3
