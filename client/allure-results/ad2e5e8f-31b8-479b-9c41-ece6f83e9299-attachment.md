...
- Name: analytics-ui.spec.js >> Analytics UI — Student Dashboard Reset to Defaults >> TC-ANL-UI-116: Click reset on overview tab shows confirmation
- Location: tests/e2e/specs/analytics-ui.spec.js:1386:3
