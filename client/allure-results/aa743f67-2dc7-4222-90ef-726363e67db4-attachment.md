...
- Name: missing-routes-ui.spec.js >> Dashboard Lookup Tabs UI — Deep >> TC-MR-UI-40: priority-types tab loads with content
...
Call log:
  - navigating to "https://localhost:5174/dashboard#priority-types", waiting until "load"
