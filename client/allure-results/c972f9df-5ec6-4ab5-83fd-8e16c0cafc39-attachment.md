...
- Name: classes-ui.spec.js >> Classes UI — Page Load & Structure >> TC-CLS-UI-004: Row count is non-zero or empty state shown
- Location: tests/e2e/specs/classes-ui.spec.js:57:3
