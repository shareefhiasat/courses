...
- Name: analytics-ui.spec.js >> Analytics UI — Student Dashboard Component Reuse (Deep) >> TC-ANL-UI-105: Overview tab — add widget button visible
- Location: tests/e2e/specs/analytics-ui.spec.js:1270:3
