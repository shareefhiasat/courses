...
- Name: attendance-ui.spec.js >> Attendance UI — Date Picker (Past/Future/Counts) >> TC-ATT-UI-051: Select future date shows attendance view
- Location: tests/e2e/specs/attendance-ui.spec.js:824:3
