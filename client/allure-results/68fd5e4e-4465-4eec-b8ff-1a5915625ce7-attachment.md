...
- Name: enrollments-ui.spec.js >> Enrollments UI — Edit & Status Flow (Deep) >> TC-ENR-UI-017: Edit button visible for existing enrollment
- Location: tests/e2e/specs/enrollments-ui.spec.js:263:3
