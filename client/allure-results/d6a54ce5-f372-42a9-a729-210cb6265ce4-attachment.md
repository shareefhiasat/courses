...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Page Load & Structure (Deep) >> TC-MENR-UI-006: Table headers present
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:63:3
