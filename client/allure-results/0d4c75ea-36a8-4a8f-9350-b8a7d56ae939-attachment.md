...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Room/Classroom Availability >> TC-SCHCAL-UI-035: Room availability calendar renders
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:430:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/scheduling-calendar?tab=availability&scope=room
Call log:
  - navigating to "https://localhost:5174/scheduling-calendar?tab=availability&scope=room", waiting until "load"
