...
- Name: dashboard-admin-ui.spec.js >> Dashboard Admin UI — Hash Tab Content (Core) >> TC-DASH-ADMIN-UI-08: Classes tab loads with content
- Location: tests/e2e/specs/dashboard-admin-ui.spec.js:113:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/dashboard#classes
Call log:
