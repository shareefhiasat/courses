...
- Name: marks-ui.spec.js >> Marks UI — Mark Entry Edge Cases >> TC-MRK-UI-097: Enter mark 59 — should be F (first attempt)
- Location: tests/e2e/specs/marks-ui.spec.js:1120:3
