...
- Name: scheduling-ui.spec.js >> Scheduling UI — Page Load & Initial State >> TC-SCH-UI-005: Create session button visible on load
- Location: tests/e2e/specs/scheduling-ui.spec.js:80:3
