...
- Name: activities-ui.spec.js >> Activities UI — Delete Flow (Read-only checks) >> TC-ACT-UI-023-readonly: Delete — cancelled, activity remains in list
- Location: tests/e2e/specs/activities-ui.spec.js:467:3
