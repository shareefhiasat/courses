...
- Name: attendance-ui.spec.js >> Attendance UI — Student Roster Display >> TC-ATT-UI-018: Student stats row visible (participation, behavior, penalty)
- Location: tests/e2e/specs/attendance-ui.spec.js:326:3
