...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — User Stories >> TC-SCHCAL-UI-063: User story — admin views room availability and sets slot
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:757:3
