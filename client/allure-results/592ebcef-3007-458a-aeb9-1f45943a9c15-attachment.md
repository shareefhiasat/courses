...
- Name: scheduling-ui.spec.js >> Scheduling UI — Filters >> TC-SCH-UI-045: Subject filter on Classes tab (locked until program selected)
- Location: tests/e2e/specs/scheduling-ui.spec.js:525:3
