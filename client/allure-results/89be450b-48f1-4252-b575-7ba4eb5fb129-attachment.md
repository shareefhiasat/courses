...
- Name: attendance-ui.spec.js >> Attendance UI — Mode Toggle (Regular vs Standup) >> TC-ATT-UI-010: Switch to standup mode changes UI
- Location: tests/e2e/specs/attendance-ui.spec.js:223:3
