...
- Name: missing-routes-ui.spec.js >> Dashboard Lookup Tabs UI — Deep >> TC-MR-UI-44: question-types tab loads with content
...
Call log:
  - navigating to "https://localhost:5174/dashboard#question-types", waiting until "load"
