...
- Name: missing-routes-ui.spec.js >> Workflow Document Detail — Deep >> TC-MR-UI-021: Workflow detail (legacy route) loads
- Location: tests/e2e/specs/missing-routes-ui.spec.js:205:3
...
Call log:
  - navigating to "https://localhost:5174/workflow/1", waiting until "load"
