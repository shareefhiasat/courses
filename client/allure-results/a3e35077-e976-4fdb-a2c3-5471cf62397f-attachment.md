...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Role-Based & Edge Cases >> TC-MENR-UI-056: Empty state when no enrollments
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:626:3
