...
- Name: users-ui.spec.js >> Users UI — Page Load & Structure >> TC-USR-UI-004: Row count is non-zero or empty state shown
- Location: tests/e2e/specs/users-ui.spec.js:64:3
