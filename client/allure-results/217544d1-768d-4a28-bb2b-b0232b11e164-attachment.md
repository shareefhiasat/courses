...
- Name: enrollments-ui.spec.js >> Enrollments UI — Read & Search (Deep) >> TC-ENR-UI-013: Sort by column header changes row order
- Location: tests/e2e/specs/enrollments-ui.spec.js:197:3
