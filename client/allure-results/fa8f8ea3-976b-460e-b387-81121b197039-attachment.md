...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Instructor Availability >> TC-SCHCAL-UI-032: Recurring availability — end date input
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:389:3
