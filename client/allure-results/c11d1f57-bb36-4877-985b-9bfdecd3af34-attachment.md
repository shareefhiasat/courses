...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-094: Instructor cannot see delete button in expanded history
- Location: tests/e2e/specs/attendance-ui.spec.js:1471:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/attendance
Call log:
