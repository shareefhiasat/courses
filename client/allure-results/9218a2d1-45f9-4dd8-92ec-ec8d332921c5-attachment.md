...
- Name: dashboard-admin-ui.spec.js >> Dashboard Admin UI — Hash Tab Content (Core) >> TC-DASH-ADMIN-UI-09: Enrollments tab loads with content
- Location: tests/e2e/specs/dashboard-admin-ui.spec.js:113:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/dashboard#enrollments
Call log:
  - navigating to "https://localhost:5174/dashboard#enrollments", waiting until "load"
