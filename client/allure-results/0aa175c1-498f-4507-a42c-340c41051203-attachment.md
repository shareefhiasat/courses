...
- Name: drive-ui.spec.js >> Smart Drive UI — Comprehensive >> page loads with sidebar and toolbar
- Location: tests/e2e/specs/drive-ui.spec.js:10:3
...
Call log:
  - navigating to "https://localhost:5174/smart-drive", waiting until "load"
