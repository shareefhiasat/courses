...
- Name: enrollments-ui.spec.js >> Enrollments UI — Role-Based Access (Deep) >> TC-ENR-UI-025: Student cannot see enroll button
- Location: tests/e2e/specs/enrollments-ui.spec.js:426:3
