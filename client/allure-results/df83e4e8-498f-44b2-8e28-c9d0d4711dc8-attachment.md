...
- Name: analytics-ui.spec.js >> Analytics UI — Scheduled Reports (Deep) >> TC-ANL-UI-082: Scheduled reports list or empty state
- Location: tests/e2e/specs/analytics-ui.spec.js:999:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/scheduled-reports
Call log:
  - navigating to "https://localhost:5174/scheduled-reports", waiting until "load"
