...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Page Load & Structure (Deep) >> TC-MENR-UI-003: Enroll student button visible
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:45:3
