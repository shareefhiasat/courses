...
- Name: analytics-ui.spec.js >> Analytics UI — Main Analytics Page (Deep) >> TC-ANL-UI-079: Analytics page — click filter changes content
- Location: tests/e2e/specs/analytics-ui.spec.js:964:3
...
Call log:
  - navigating to "https://localhost:5174/analytics", waiting until "load"
