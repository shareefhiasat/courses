...
- Name: enrollments-ui.spec.js >> Enrollments UI — Read & Search (Deep) >> TC-ENR-UI-012: Pagination controls visible if many enrollments
- Location: tests/e2e/specs/enrollments-ui.spec.js:190:3
