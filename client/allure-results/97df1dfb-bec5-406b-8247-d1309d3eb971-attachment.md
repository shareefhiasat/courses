...
- Name: analytics-ui.spec.js >> Analytics UI — Widget Actions (Deep) >> TC-ANL-UI-056: Widget minimize button visible on hover
- Location: tests/e2e/specs/analytics-ui.spec.js:656:3
