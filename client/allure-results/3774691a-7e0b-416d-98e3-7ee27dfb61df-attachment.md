...
- Name: classes-ui.spec.js >> Classes UI — Create Flow (Deep) >> TC-CLS-UI-006: Create form opens with expected fields
- Location: tests/e2e/specs/classes-ui.spec.js:79:3
