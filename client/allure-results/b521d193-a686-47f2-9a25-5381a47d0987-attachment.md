...
- Name: auth.spec.js >> Authentication — Unauthorized Page >> TC-AUTH-043: Unauthorized page shows contact admin help text
- Location: tests/e2e/specs/auth.spec.js:531:3
