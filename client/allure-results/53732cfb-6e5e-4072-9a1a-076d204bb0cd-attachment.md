...
- Name: attendance-ui.spec.js >> Attendance UI — Mode Toggle (Regular vs Standup) >> TC-ATT-UI-008: Regular mode — class selection section visible
- Location: tests/e2e/specs/attendance-ui.spec.js:207:3
