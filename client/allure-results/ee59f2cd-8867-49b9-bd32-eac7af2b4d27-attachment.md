...
- Name: manage-enrollments-ui.spec.js >> Manage Enrollments UI — Role-Based & Edge Cases >> TC-MENR-UI-054: Student cannot see withdraw button
- Location: tests/e2e/specs/manage-enrollments-ui.spec.js:602:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/manage-enrollments
Call log:
