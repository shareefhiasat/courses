...
- Name: missing-routes-ui.spec.js >> Workflow Document Detail — Deep >> TC-MR-UI-020: Workflow document detail loads
- Location: tests/e2e/specs/missing-routes-ui.spec.js:199:3
...
- generic [ref=e3]:
  ...
  - main [ref=e240]:
    - generic [ref=e244]:
      - img [ref=e245]
      - generic [ref=e247]: Request failed with status code 404
```