...
- Name: announcements-ui.spec.js >> Announcements UI — Tab Switching (Deep) >> TC-ANN-UI-022: Switch from programs to announcements tab — content changes
- Location: tests/e2e/specs/announcements-ui.spec.js:384:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/dashboard#programs
Call log:
  - navigating to "https://localhost:5174/dashboard#programs", waiting until "load"
