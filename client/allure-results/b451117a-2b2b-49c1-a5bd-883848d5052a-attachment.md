...
- Name: attendance-ui.spec.js >> Attendance UI — Role-Based Access (RBAC) >> TC-ATT-UI-090: Admin can mark attendance (Start Session visible)
- Location: tests/e2e/specs/attendance-ui.spec.js:1421:3
