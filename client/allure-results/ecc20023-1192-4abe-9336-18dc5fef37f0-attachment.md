...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Room/Classroom Availability >> TC-SCHCAL-UI-042: Room availability — existing slots visible
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:512:3
