...
- Name: chat-api.spec.js >> Chat API >> TC-CHAT-004: GET /chat/rooms returns only enrolled class rooms for students
- Location: tests/e2e/specs/chat-api.spec.js:34:3
...
```ts
  ...
  2   |  * Chat API Tests
  3   |  * Module: chat
  4   |  * Covers: TC-CHAT-001 through TC-CHAT-015
  5   |  */
