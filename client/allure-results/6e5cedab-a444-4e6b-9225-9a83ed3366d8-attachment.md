...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Room/Classroom Availability >> TC-SCHCAL-UI-043: Room availability — delete slot button
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:519:3
