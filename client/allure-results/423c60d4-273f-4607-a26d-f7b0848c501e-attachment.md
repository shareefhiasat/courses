...
- Name: activities-ui.spec.js >> Activities UI — Edit Flow (Read-only checks) >> TC-ACT-UI-018: Edit button visible for existing activity
- Location: tests/e2e/specs/activities-ui.spec.js:383:3
