...
- Name: scheduling-ui.spec.js >> Scheduling UI — Calendar Views (Day/Week/Month) >> TC-SCH-UI-022: Rapid view switching Day→Week→Month does not crash
- Location: tests/e2e/specs/scheduling-ui.spec.js:240:3
