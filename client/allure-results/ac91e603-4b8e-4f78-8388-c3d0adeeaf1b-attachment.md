...
- Name: analytics-ui.spec.js >> Analytics UI — Summary Dashboard (Deep) >> TC-ANL-UI-004: Analytics charts render (canvas/svg/recharts)
- Location: tests/e2e/specs/analytics-ui.spec.js:99:3
