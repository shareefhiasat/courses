...
- Name: scheduling-availability-ui.spec.js >> Scheduling Calendar UI — Tab Switch Verification >> TC-SCHCAL-UI-051: Switch from classes to instructor availability changes content
- Location: tests/e2e/specs/scheduling-availability-ui.spec.js:596:3
