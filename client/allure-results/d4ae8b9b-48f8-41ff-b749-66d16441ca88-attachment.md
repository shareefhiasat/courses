...
- Name: missing-routes-ui.spec.js >> Dashboard Lookup Tabs UI — Deep >> TC-MR-UI-41: user-roles tab loads with content
...
Call log:
  - navigating to "https://localhost:5174/dashboard#user-roles", waiting until "load"
