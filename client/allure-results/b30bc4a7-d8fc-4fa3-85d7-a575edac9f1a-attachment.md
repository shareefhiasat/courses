...
- Name: analytics-ui.spec.js >> Analytics UI — Widget Actions (Deep) >> TC-ANL-UI-059: Widget edit button opens builder in edit mode
- Location: tests/e2e/specs/analytics-ui.spec.js:707:3
