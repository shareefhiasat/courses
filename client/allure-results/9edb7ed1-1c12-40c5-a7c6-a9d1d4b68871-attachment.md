...
- Name: home-ui.spec.js >> Home Page UI — Activity Filters (Deep) >> TC-HOME-UI-012: Search activities filters results
- Location: tests/e2e/specs/home-ui.spec.js:140:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/?mode=activities
Call log:
  - navigating to "https://localhost:5174/?mode=activities", waiting until "load"
