...
- Name: classes-ui.spec.js >> Classes UI — Create Flow (Deep) >> TC-CLS-UI-009: Cancel button — form data not saved without submit
- Location: tests/e2e/specs/classes-ui.spec.js:132:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_TIMED_OUT at https://localhost:5174/dashboard?tab=classes
Call log:
