...
- Name: enrollments-ui.spec.js >> Enrollments UI — Read & Search (Deep) >> TC-ENR-UI-011: Click enrollment row to view detail
- Location: tests/e2e/specs/enrollments-ui.spec.js:178:3
