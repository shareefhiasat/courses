...
- Name: classes-ui.spec.js >> Classes UI — Edge Cases >> TC-CLS-UI-033: Empty state message when no classes match search
- Location: tests/e2e/specs/classes-ui.spec.js:521:3
