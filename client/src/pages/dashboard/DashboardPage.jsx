...
const EnrollmentsManagementPage = lazy(() => import('../enrollments/EnrollmentsManagementPage'));
const EnrollmentsPage = lazy(() => import('../enrollments/EnrollmentsPage'));
...
const ClassSchedulePage = lazy(() => import('../classes/ClassSchedulePage'));
const PenaltiesPage = lazy(() => import('../operations/behavior/PenaltiesPage'));
const ParticipationPage = lazy(() => import('../operations/behavior/ParticipationPage'));
