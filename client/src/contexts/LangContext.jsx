...
const DICT = {
  en: {
    ...
    students_can_register: 'Students with these email addresses can register and access the platform',
    admins_get_privileges: 'Users with these email addresses get admin privileges and dashboard access',
    import_multiple: 'Import multiple',
    add: 'Add',
    email: 'Email',
    total: 'Total',
    ...
    app_password_placeholder: '16-character app password',
    sender_name_placeholder: 'CS Learning Hub',
    activity_id: 'Activity ID',
    title_english: 'Title (English)',
    title_arabic: 'Title (Arabic)',
    description_english: 'Description (English)',
    ...
    class_code_placeholder: 'Class Code (optional)',
    resource_title_placeholder: 'Resource Title',
    resource_description_placeholder: 'Resource Description (optional)',
    resource_url_placeholder: 'Resource URL',
  ...
  ar: {
    ...
    // Allowlist & Permissions
    students_can_register: 'الطلاب الذين لديهم عناوين البريد الإلكتروني هذه يمكنهم التسجيل والوصول إلى المنصة',
    admins_get_privileges: 'المستخدمون الذين لديهم عناوين البريد الإلكتروني هذه يحصلون على امتيازات المشرف والوصول إلى لوحة التحكم',
    import_multiple: 'استيراد متعدد',
    add: 'إضافة',
    email: 'البريد الإلكتروني',
    total: 'المجموع',
    allowlist_management: 'إدارة قائمة السماح',
    allowed_emails: 'البريد الإلكتروني المسموح',
    admin_emails: 'بريد المشرفين',
    progress: 'التقدم',
    // Search placeholders
    search_users: 'ابحث عن المستخدمين بالبريد أو الاسم',
    search_activities: 'ابحث عن الأنشطة',
    search_resources: 'ابحث عن الموارد',
    search_enrollments: 'ابحث عن التسجيلات',
    search_announcements: 'ابحث عن الإعلانات',
    search_classes: 'ابحث عن الصفوف بالاسم أو الرمز',
    search_submissions: 'ابحث عن التسليمات بالنشاط أو الطالب',
    search_by_email_name_ua: 'ابحث بالبريد أو الاسم أو UA',
    announcement_content_english: 'محتوى الإعلان (إنجليزي)',
    announcement_content_arabic: 'محتوى الإعلان (عربي) - المحتوى بالعربية',
    smtp_host_placeholder: 'smtp.gmail.com',
    smtp_port_placeholder: '587',
    email_placeholder: 'your-email@gmail.com',
    app_password_placeholder: 'كلمة مرور التطبيق (16 حرف)',
    sender_name_placeholder: 'مركز تعلم علوم الحاسب',
    ...
    user_display_name_placeholder: 'الاسم المعروض (اختياري)',
    allowlist_email_placeholder: 'email@example.com',
