...
export const PenaltyIcon = ({ style = {} }) => (
  <svg style={style} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
    <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-2.34 0l-4.68 4.69a2.06 2.06 0 0 0-.29-.29l.85-.85a1.98 1.98 0 0 0-.56-.1L8.09 9.91a1.94 1.94 0 0 0-.46.1l-.85.85a2.06 2.06 0 0 0-.29-.29z"/>
