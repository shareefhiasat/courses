...
import { FileDown, Search, Filter, Calendar, User, AlertCircle, Clock, CheckCircle, XCircle, Activity, Users } from 'lucide-react';
            ...
            {sessions.map((session, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div style={{ fontSize: 11, color: session.status === 'open' ? '#10b981' : '#6b7280', marginTop: 2, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 4 }}>
                    {session.status === 'open' ? (
                      <>
                      ...
                      <>
                        <span style={{ display: 'inline-block', width: 8, height: 8, borderRadius: '50%', background: '#6b7280' }}></span>
                        Ended
                      </>
                    )}
                  </div>
          ...
          {selectedSession && (
            <>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                <div style={{ flex: 1 }}>
                  <div style={{ fontWeight: 700, fontSize: 18, marginBottom: '0.5rem' }}>
                  ...
                  {selectedSession.instructorName && (
                    <div style={{ fontSize: 12, color: 'var(--muted)', marginBottom: '0.25rem' }}>
                      👤 {selectedSession.instructorName}
                    </div>
                  )}
                  <div style={{ fontSize: 11, color: 'var(--muted)', marginBottom: '0.25rem', fontFamily: 'monospace' }}>
              ...
              <div style={{ maxHeight: 400, overflowY: 'auto' }}>
                ...
                <div style={{ display: 'grid', gap: 8 }}>
                  {marks.map((mark, idx) => {
                    ...
                    return (
                      <div key={uniqueKey} style={{ padding: '0.75rem', border: '1px solid var(--border)', borderRadius: 8, background: '#fff' }}>
