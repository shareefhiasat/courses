...
import { useLang as useLangContext } from '../contexts/LangContext';
import {
                ...
                <CardBody>
                  ...
                  <div className={styles.questionForm}>
                    <div className={styles.questionTextEditor}>
                      <RichTextEditor
                        key={`question-text-${quizData.questions[activeQuestionIndex]?.id || activeQuestionIndex}`}
                        label="Question Text"
                        ...
                        onChange={(html) => {
                          ...
                          if (currentQuestion && currentQuestion.id) {
                            updateQuestion(activeQuestionIndex, { question: html });
                          }
                        }}
                        height={120}
